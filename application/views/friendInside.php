<body class="bg-info">
    ...
    <footer class="fixed-bottom bg-dark">
        <form id="sendFriendMessage" method="POST">
            <div class="input-group py-3 px-3">
                ...
                <textarea name="friendMessage" class="form-control" aria-label="With textarea"></textarea>
                <input type="hidden" id="friendId" name="friendId" value="<?php echo urldecode($this->uri->segment(3)); ?>">
            </div>
        </form>
    </footer>
    ...
    <script type="text/javascript">
        ...
        var current = null;
        var result=null;
        console.log(BASE_URL + friendId);
    </script>
    <script type="text/javascript" src="<?php echo base_url('assets/js/friendInside.js') ?>"></script>
    <!--Javascript、Jquery、Ajax導入/結束-->
</body>
